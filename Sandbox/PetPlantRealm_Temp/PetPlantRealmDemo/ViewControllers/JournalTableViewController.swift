...
class JournalTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.emotionalStateTextLabel.text = getEmotionalStateOfThisJournal(journal: journal)
        switch getEmotionalStateOfThisJournal(journal: journal) {
        case "기쁨":
            cell.emotionalStateImageView.tintColor = .yellow
        case "평온":
            cell.emotionalStateImageView.tintColor = .green
        case "걱정":
            cell.emotionalStateImageView.tintColor = .purple
        case "슬픔":
            cell.emotionalStateImageView.tintColor = .blue
        case "분노":
            cell.emotionalStateImageView.tintColor = .red
        default:
